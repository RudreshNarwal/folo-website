        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="flex-1 flex justify-end">
              <div className="relative w-72 md:w-80 lg:w-80 mx-auto md:mx-0">
                {/* Phone frame */}
                <div className="relative z-10 overflow-hidden rounded-[2.5rem] bg-[#121212] shadow-xl">
                  {/* Phone screen */}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-background/20 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
            ...
            <div className="flex space-x-5 mt-4 md:mt-0">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-background/70 hover:text-primary transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M9 12a4 4 0 1 0 0 8 4 4 0 0 0 0-8z"></path>
                  <path d="M15 8c0 1.66-1.34 3-3 3"></path>
                  <path d="M16 12V3h-2c0 4-3 5-6 5v2c3.5 0 6 1.5 6 5m2-2v6"></path>
                </svg>
              </a>
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-background/70 hover:text-primary transition-colors">
